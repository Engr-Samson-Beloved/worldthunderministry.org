        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2 space-y-8">
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
              At his early, during a life-changing moment with God, Prophet S.P. Olabanji had
               a deep spiritual encounter that marked the beginning of his divine assignment. He described 
               it as a "WORLD THUNDER REVIVAL AND EVANGELICAL MINISTRY" that struck his heart and confirmed his calling into ministry. 
               That sacred encounter would later become the foundation and name of the ministry — **World Thunder 
               Revival and Evangelical Ministry (WOTREM)**.
              </p>
              <p className="text-gray-700 leading-relaxed">
              Before fully launching into ministry, Prophet S.P. Olabanji pursued spiritual and theological
               training to prepare for the calling upon his life. He enrolled at the **CAC Babajide School of 
               Prophets and Evangelists**, a renowned seminary where he was equipped with deep biblical knowledge,
                prophetic discipline, and evangelistic fire. There, he earned his **Diploma in Ministry**, a foundational
                 step that strengthened his spiritual roots and sharpened his
               understanding of God's word — all in preparation for the birth of the ministry God had placed in his heart.
              </p>
            </section>
            ...
            <section>
              ...
              The vision for World Thunder Revival and Evangelical Ministry (WOTREM) was birthed in the heart of
               Prophet S.P. Olabanji in 1995. It began in a remote village with a
               small group of devoted believers gathering consistently under divine instruction. Despite
                the humble beginnings, the atmosphere was filled
               with power, prayers, and the prophetic — marking the foundation of what would soon become
              ...
              As the work grew, Prophet Olabanji faced several challenges — especially concerning location and space.
               ...
               unwavering faith, he continued the
              assignment, trusting God for divine direction and provision even through seasons of hardship and uncertainty.
              </p>
              <p className="text-gray-700 leading-relaxed">
              In 2012, after many trials and years of endurance, God miraculously provided a permanent and 
              expansive location — now known as Redemption Mountain in Ondo City. It became the official 
              headquarters and holy ground for WOTREM. From that mountain, revival, deliverance, and evangelism have gone 
              forth across regions, with countless lives transformed through the prophetic mandate on 
              Prophet Olabanji’s life.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
              WOTREM is rooted in a deep, unwavering belief in the power of prayer, deliverance, and
               uncompromising truth of God’s Word. Prophet S.P. Olabanji leads the ministry with a philosophy
                grounded in spiritual sensitivity, prophetic insight, and complete dependence on the Holy Spirit. 
              The goal is to raise a generation that fears God, walks in holiness, and lives with kingdom purpose.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              Over the years, the ministry has become a haven for the oppressed, afflicted, and spiritually hungry.
               Testimonies of healing, accurate prophecy, breakthroughs, and genuine repentance abound in every gathering. 
               Many who came broken have encountered the raw power
               of God and left completely transformed — a proof of the anointing upon the ministry and its divine backing.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed">
              Through consistent revival meetings, evangelistic outreaches, and sound discipleship,
               WOTREM has expanded its reach locally and internationally. The impact continues to grow
                through media, missions, and training institutions like the Thunder Ministry Institution 
                (OTC). WOTREM is not just a church — it is a spiritual movement changing lives, cities, and 
                destinies for God’s glory.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Behind the public ministry, Prophet SP. Olabanji is a devoted family man. He has been married to his wife, Mary,
                for over 25 years. She serves alongside him as the ministry's co-pastor and oversees the women's
                department. Together, they have four children who are all actively involved in various aspects of the
                ministry.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              of the Lord. 
              His home is built on prayer, discipline, and godly values — reflecting the same principles he teaches publicly.
              </p>
              <p className="text-gray-700 leading-relaxed">
                ...
                Despite the demands of full-time ministry, he remains deeply connected to his family,
                 leading them with integrity, love, and spiritual authority. His life is a
                 testimony of balancing divine calling with family responsibility,
                  showing that ministry truly begins at home.
              </p>
            </section>
            ...
            <div className="p-8 bg-gold-50 border border-gold-200 rounded-lg">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                AAs WOTREM approaches its third decade, Prophet S.P. Olabanji envisions a global move of God —
                 expanding WOTREM into
                 a worldwide mission hub, training centers, and media arms that will carry revival fire to the 
                 ends of the earth
              </p>
              <p className="text-gray-700 leading-relaxed">
